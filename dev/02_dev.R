...
golem::add_module( name = "access" )
golem::add_module( name = "enroll" )
golem::add_module( name = "tests" )
...
## Vignette ----
usethis::use_vignette("egggolemreg")
